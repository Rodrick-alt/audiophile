  ...
  return (
    <div className='AppProduct App'>
      ...
      <section className='productDetails pageProduct'>
        <img width='500px' height='518.516px' src={require("../../Assets/product-xx99-mark-one-headphones/" + imgFolder + "/image-product.jpg")} alt='HeadPhones' />
        <div>
          ...
          <strong className='price'>$1,750</strong>
            ...
            <button
              onClick={() => {
                dispatch(cartArrAdd(([
                  ...
                  1750,
                  amountNum,
                  "product-xx99-mark-one-headphones/desktop/image-product.jpg"
                ])));
              }}
            >
              ADD TO CART
      ...
      <section className='gallery'>
        <div className='div--special'>
          <img loading='lazy' width='457.688px' heigh='287.969px' src={require("../../Assets/product-xx99-mark-one-headphones/" + imgFolder + "/image-gallery-1.jpg")} alt='HeadPhones' />
          <img loading='lazy' width='457.688px' heigh='287.969px' src={require("../../Assets/product-xx99-mark-one-headphones/" + imgFolder + "/image-gallery-2.jpg")} alt='HeadPhones' />
        </div>
        <div>

          <img loading='lazy' width='643.312px' heigh='599.734px' src={require("../../Assets/product-xx99-mark-one-headphones/" + imgFolder + "/image-gallery-3.jpg")} alt='HeadPhones' />
        </div>
      ...
      <section className='suggestions'>
        ...
        <div className='div--container'>
          <div>
            <img loading='lazy' width='350px' height='318px' src={require("../../Assets/shared/" + imgFolder + "/image-xx99-mark-two-headphones.jpg")} alt='HeadPhones' />
            <h2>XX99 MARK II</h2>
            <Link to="/XX99MARKII">
          ...
          <div>
            <img loading='lazy' width='350px' height='318px' src={require("../../Assets/shared/" + imgFolder + "/image-zx9-speaker.jpg")} alt='Speakers' />
            <h2>ZX9 SPEAKER</h2>
            <Link to="/ZX9">
              <button>SEE PRODUCT</button>
            </Link>
