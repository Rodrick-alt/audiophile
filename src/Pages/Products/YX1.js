  ...
  return (
    <div className='AppProduct App'>
      ...
      <section className='productDetails pageProduct'>
        <img width='500px' height='518.516px' src={require("../../Assets/product-yx1-earphones/" + imgFolder + "/image-product.jpg")} alt='HeadPhones' />
        <div>
          <span>NEW PRODUCT</span>
          <h1>YX1 WIRELESS EARPHONES</h1>
          <p>Tailor your listening experience with
            bespoke dynamic drivers from the new YX1
            Wireless Earphones. Enjoy incredible
            high-fidelity sound even in noisy environments
